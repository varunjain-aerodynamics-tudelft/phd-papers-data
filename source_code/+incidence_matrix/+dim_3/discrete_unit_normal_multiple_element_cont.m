function [local_NK] = discrete_unit_normal_multiple_element_cont(p, Kx, Ky, Kz, globl_dof_rght, globl_dof_left, globl_dof_topp, globl_dof_bttm, globl_dof_frnt, globl_dof_back)
