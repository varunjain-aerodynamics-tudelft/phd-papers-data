function [local_NK] = unit_normal_bot_boundary(p, Kx, Ky, Kz, globl_dof_rght, globl_dof_left, globl_dof_topp, globl_dof_bttm, globl_dof_frnt, globl_dof_back)
...
nr_boundary_lambda_bttm = p^2*Kx*Kz;
...
% local_NK = sparse(1:nr_boundary_lambda,local_bndry_dof_NK,NNK,nr_boundary_lambda,ttl_loc_dof3);

local_NK = sparse(1:nr_boundary_lambda_bttm,boundary_face_bttm,NK.bttm,nr_boundary_lambda_bttm,ttl_loc_dof3);
