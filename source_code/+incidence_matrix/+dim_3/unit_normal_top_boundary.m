function [local_NK] = unit_normal_top_boundary(p, Kx, Ky, Kz, globl_dof_rght, globl_dof_left, globl_dof_topp, globl_dof_bttm, globl_dof_frnt, globl_dof_back)
...
nr_boundary_lambda_top = p^2*Kx*Kz;
...
local_NK = sparse(1:nr_boundary_lambda_top,boundary_face_topp,NK.topp,nr_boundary_lambda_top,ttl_loc_dof3);
