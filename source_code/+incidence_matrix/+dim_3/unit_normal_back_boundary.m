function [local_NK] = unit_normal_back_boundary(p, Kx, Ky, Kz, globl_dof_rght, globl_dof_left, globl_dof_topp, globl_dof_bttm, globl_dof_frnt, globl_dof_back)
...
nr_boundary_lambda_back = p^2*Kx*Ky;
...
local_NK = sparse(1:nr_boundary_lambda_back,boundary_face_back,NK.back,nr_boundary_lambda_back,ttl_loc_dof3);
